...
namespace GLOBAL {
    ...
    namespace PATH {
        static const QString WORK = QDir::currentPath();      // 当前工作目录
        static const QString TMP = FileHelper::joinPath(WORK, "temp");  // 临时目录，如存放数据库文件
        static const QString LOG_DIR = FileHelper::joinPath(WORK, "qos/logs");
    ...
    enum LOG_LEVEL { TOTAL = 0, DEBUG = 1, INFO = 2, WARNING = 3, ERROR = 4, FATAL = 5 };
    static const QStringList LOG_NAMES = {"TOTAL", "DEBUG", "INFO", "WARNING", "ERROR", "FATAL"};
