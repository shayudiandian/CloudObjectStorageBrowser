...
{
    static QString lastDir = "./";          // 每一次选择从上次记住的位置选择
    // 获取本地文件
...
void UiObjectsTableWidget::on_btnDownload_clicked()
{
    ...
    QString name = idx.data().toString();   // 文件名
